...
class PolePoseNode:
    def __init__(self, in_topic, out_topic) -> None:
        ...
        self.points_3d = np.array([
                                (0.0167, 0.0,      1.185), # tip
                                (0.0167, -0.0623,  1.005), # top_l
                                (0.0167, 0.0623,   1.005), # top_r
                                (0.0167, -0.0623,  0.505), # mid_l
                                (0.0167, 0.0623,   0.505), # mid_r
                                (0.0167, -0.0623,  0.0), # bottom_l
                                (0.0167, 0.0623,   0.02) # bottom_r
                                ])
